                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/persona/registrar">
                        ...
                        <div class="form-group{{ $errors->has('cedula') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="cedula" type="text" maxlength="9" onKeyPress="return soloNumeros(event)" class="form-control" name="cedula" value="{{ old('cedula') }}" required autofocus>
                        ...
                        <div class="juridica" style="display: none;">
                            ...
                            <div class="form-group{{ $errors->has('rif') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="rif" type="text" class="form-control" name="rif" value="{{ old('rif') }}" required autofocus disabled="disabled">
                            ...
                            <div class="form-group{{ $errors->has('representante') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="representante" type="text" class="form-control" name="representante" value="{{ old('representante') }}" required autofocus disabled="disabled" >
                            ...
                            <div class="col-md-6">
                                <select class="form-control" id="nivel_educativo" class="form-control" name="nivel_educativo" value="{{ old('nivel_educativo') }}" required autofocus>
                                  ...
                                  <option value="primaria"
                                   {{ old('nivel_educativo' ) ==  "primaria" ? 'selected' : '' }}>
                               primaria
                                </option>
                                  <option value="secundaria"
                                   {{ old('nivel_educativo' ) ==  "secundaria" ? 'selected' : '' }}>
                               secundaria
                                </option>
                                  <option value="bachiderato"
                                   {{ old('nivel_educativo' ) ==  "bachiderato" ? 'selected' : '' }}>
                               bachiderato
                                </option>
                                  <option value="tsu"
                                   {{ old('nivel_educativo' ) ==  "tsu" ? 'selected' : '' }}>
                               tsu
                                </option>
                                  <option value="universitario"
                                   {{ old('nivel_educativo' ) ==  "universitario" ? 'selected' : '' }}>
                               universitario
                                </option>
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('municipio') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" id="municipio" class="form-control" name="municipio" value="{{ old('municipio') }}" required autofocus>
                                  <option value="">seleccione una opcion</option>
                                  <option value="Caroní" {{ old('municipio' ) == "Caroní" ? 'selected' : '' }}> Caroní </option>

                                  <option value="Cedeño"{{ old('municipio' ) == "Cedeño" ? 'selected' : '' }}> Cedeño </option>

                                  <option value="El Callao"{{ old('municipio' ) == "El Callao" ? 'selected' : '' }}> El Callao </option>

                                  <option value="Gran Sabana"{{ old('municipio' ) == "Gran Sabana" ? 'selected' : '' }}> Gran Sabana </option>

                                  <option value="Heres"{{ old('municipio' ) == "Heres" ? 'selected' : '' }}> Heres </option>

                                  <option value="Padre Pedro Chien"{{ old('municipio' ) == "Padre Pedro Chien" ? 'selected' : '' }}> Padre Pedro Chien </option>

                                  <option value="Piar"{{ old('municipio' ) == "Piar" ? 'selected' : '' }}> Piar </option>

                                  <option value="Angostura (Raúl Leoni)"{{ old('municipio' ) == "Angostura (Raúl Leoni)" ? 'selected' : '' }}> Angostura (Raúl Leoni) </option>

                                  <option value="Roscio"{{ old('municipio' ) == "Roscio" ? 'selected' : '' }}> Roscio </option>

                                  <option value="Sifontes"{{ old('municipio' ) == "Sifontes" ? 'selected' : '' }}> Sifontes </option>
                        ...
                        <div class="form-group{{ $errors->has('parroquia') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" id="parroquia" class="form-control parroquia" name="parroquia" value="{{ old('parroquia') }}" required autofocus>
                                  <option value="">seleccione una opcion</option>
                        ...
                        <div class="form-group{{ $errors->has('telefono') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" maxlength="11" type="text" onKeyPress="return soloNumeros(event)" class="form-control" name="telefono" value="{{ old('telefono') }}" required autofocus>
